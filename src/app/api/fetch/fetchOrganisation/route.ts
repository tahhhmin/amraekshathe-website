...
export async function GET() {
    try {
        ...
        console.log("API sending organizations (slug check):", organizations.map(org => ({ _id: org._id, slug: org.slug, name: org.organizationName })));
        ...
        const formattedOrganizations = organizations.map(org => ({
            _id: org._id.toString(), // Convert ObjectId to string
